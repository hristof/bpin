	<section class="body">
		...
		<div class="list">
			<ul> <!--Тук е мястото за листинга. Не съм слагал <li> тагове , тъй като те ще се слагат от скрипта-->
				<li> <img src="<? echo base_url().'assets/img/image1.jpg'; ?>" /> <p class="description">Space</p> </li>
				...
				<li> <img src="<? echo base_url().'assets/img/image1.jpg'; ?>" /> <p class="description">Animals</p> </li>
				<li> <img src="<? echo base_url().'assets/img/image2.png'; ?>" /> <p class="description">Food</p> </li>
			</ul>
			<div class="clear"> </div>
		</div>
	</section>
